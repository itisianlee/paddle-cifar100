...
class MobileNetV2(nn.Layer):
    def __init__(self, scale=1.0, num_classes=100, with_pool=True):
        ...
        self.last_channel = _make_divisible(last_channel * max(1.0, scale), round_nearest)
...
def mobilenetv2(scale=1.0, **kwargs):
    """MobileNetV2
    ...
    """
    model = _mobilenet('mobilenetv2_' + str(scale), scale=scale, **kwargs)
    return model
